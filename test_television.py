...
def test_init():
    ...
    tv = Television()
    assert not tv._Television__status  # TV should be off
    assert not tv._Television__muted  # TV should not be muted
    assert tv._Television__volume == Television.MIN_VOLUME  # Volume should be at minimum
    assert tv._Television__channel == Television.MIN_CHANNEL  # Channel should be at minimum

def test_power():
    """Test toggling the power status."""
    tv = Television()
    tv.power()
    assert tv._Television__status  # TV should be on
    tv.power()
    assert not tv._Television__status  # TV should be off
...
def test_channel_down():
    ...
    tv.power()
    tv.channel_down()
    assert tv._Television__channel == Television.MAX_CHANNEL  # Should cycle to MAX_CHANNEL
    tv.channel_down()
...
def test_volume_up():
    ...
    tv.volume_up()
    tv.volume_up()
    assert tv._Television__volume == Television.MAX_VOLUME  # Should remain at MAX_VOLUME
    tv.volume_up()
    assert tv._Television__volume == Television.MAX_VOLUME  # No change beyond max
...
def test_mute_volume_interaction():
    ...
    tv.mute()
    tv.volume_up()
    assert not tv._Television__muted  # Adjusting volume unmutes
    assert tv._Television__volume == Television.MIN_VOLUME + 1
    tv.mute()
    tv.volume_down()
    assert not tv._Television__muted  # Adjusting volume unmutes
